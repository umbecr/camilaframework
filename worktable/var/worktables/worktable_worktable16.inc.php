...
if (camila_form_in_update_mode(worktable_worktable16)) {
    ...
    $form = new dbform('worktable_worktable16', 'id');
    ...
    new form_date($form, 'nuovocampo', 'DATA PARTENZA', false, '');
...
$form->fields['organizzazione']->autosuggest_destfields = '';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,nuovocampo,nuovocampo2,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,nuovocampo,nuovocampo2,note';
      ...
      $stmt = 'select ' . $report_fields . ' from worktable_worktable16';
      $report = new report($stmt.$filter, '', 'organizzazione', 'asc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,nuovocampo,nuovocampo2,note', '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
