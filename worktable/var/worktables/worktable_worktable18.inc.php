...
if (camila_form_in_update_mode(worktable_worktable18)) {
    ...
    $form = new dbform('worktable_worktable18', 'id');
...
{
$form->fields['codicebadge']->autosuggest_table = 'worktable_worktable11';
...
{
$form->fields['cognome']->autosuggest_table = 'worktable_worktable11';
...
{
$form->fields['nome']->autosuggest_table = 'worktable_worktable11';
...
{
$form->fields['organizzazione']->autosuggest_table = 'worktable_worktable11';
...
$form->fields['organizzazione']->autosuggest_destfields = 'codicebadge,cognome,nome';
    ...
    $form->draw();
      ...
      $stmt = 'select ' . $report_fields . ' from worktable_worktable18';
      $report = new report($stmt.$filter, '', 'oraregistrazione', 'desc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,codicebadge,cognome,nome,organizzazione,tipopasto,oraregistrazione,codicepasto', '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
