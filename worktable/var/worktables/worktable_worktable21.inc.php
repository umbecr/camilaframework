...
if (camila_form_in_update_mode(worktable_worktable21)) {
    ...
    $form = new dbform('worktable_worktable21', 'id');
...
$form->fields['organizzazione']->autosuggest_destfields = 'codicebadge,cognome,nome';
    ...
    $form->draw();
      ...
      $stmt = 'select ' . $report_fields . ' from worktable_worktable21';
      $report = new report($stmt.$filter, '', 'oraregistrazione', 'desc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,codicebadge,cognome,nome,organizzazione,tipopasto,oraregistrazione,codicepasto', '', true, true);
