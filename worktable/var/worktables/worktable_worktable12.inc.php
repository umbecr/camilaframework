...
if (is_object($form->fields['codicebadge'])) $form->fields['codicebadge']->defaultvalue = worktable_parse_default_expression('${prefissocodiceabarre}${codice riga}', $form);
    ...
    $form->draw();
      ...
      $report = new report($stmt.$filter, '', 'cognome', 'asc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,cognome,nome,organizzazioneentesocieta,accessodal,accessoal,codicebadge', '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
