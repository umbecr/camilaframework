...
if (camila_form_in_update_mode(worktable_worktable8)) {
    ...
    $form = new dbform('worktable_worktable8', 'id');
...
if (is_object($form->fields['codicebadge'])) $form->fields['codicebadge']->defaultvalue = worktable_parse_default_expression('${prefissocodiceabarre}${codice riga}', $form);
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,cognome,nome,organizzazioneentesocieta,accessodal,accessoal,codicebadge,motivazione,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,cognome,nome,organizzazioneentesocieta,accessodal,accessoal,codicebadge,motivazione,note';
      ...
      $stmt = 'select ' . $report_fields . ' from worktable_worktable8';
      $report = new report($stmt.$filter, '', 'cognome', 'asc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,cognome,nome,organizzazioneentesocieta,accessodal,accessoal,codicebadge,motivazione,note', '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
