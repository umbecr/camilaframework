...
if (is_object($form->fields['numero'])) $form->fields['numero']->defaultvalue = worktable_get_next_autoincrement_value('worktable_worktable8','numero');
    ...
    new form_static_listbox($form, 'x', '4X4', 'N,S', false, '');

    
    new form_static_listbox($form, 'cassone', 'CASSONE', 'N,A,C', false, '');

    
    new form_integer($form, 'postiasedere', 'POSTI A SEDERE', false, 5, 255, '');
if (is_object($form->fields['postiasedere'])) $form->fields['postiasedere']->defaultvalue = worktable_get_next_autoincrement_value('worktable_worktable8','postiasedere');
...
$form->fields['organizzazione']->autosuggest_destfields = '';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,numero,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,numero,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,note';
      ...
      $report = new report($stmt, '', 'organizzazione', 'asc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,numero,organizzazione,marcaemodello,targa,x,cassone,postiasedere,turno,note', '', true, true);
