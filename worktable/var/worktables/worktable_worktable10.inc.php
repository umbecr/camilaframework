...
if (is_object($form->fields['tot'])) $form->fields['tot']->updatable = false;
    ...
    $form->draw();
      ...
      $report = new report($stmt.$filter, '', 'prodotto', 'asc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,prodotto,cod,udm,qtiniziale,tot as cf_formula_tot,c1,s,c2,s1,c3,s2,c4,s3,c5,s4,c6,s5,c7,s6,note', '', (isset($_REQUEST['camila_rest'])) ? false : true, (isset($_REQUEST['camila_rest'])) ? false : true);
