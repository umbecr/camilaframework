...
{
$form->fields['assegnatariorichiesta']->autosuggest_table = 'worktable_worktable6';
...
$form->fields['assegnatariorichiesta']->autosuggest_destfields = '';
    ...
    $form->draw();
      ...
      $report = new report($stmt, '', 'data1', 'asc', $mapping, null, 'id', 'cf_bool_is_special,cf_bool_is_selected,data1,richiedente,richiesta,tiporichiesta,priorit,assegnatariorichiesta,stato,note', '', true, true);
