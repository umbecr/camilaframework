...
if (camila_form_in_update_mode(worktable_worktable19)) {
    ...
    $form = new dbform('worktable_worktable19', 'id');
...
{
$form->fields['codicebadge']->autosuggest_table = 'worktable_worktable12';
...
{
$form->fields['cognome']->autosuggest_table = 'worktable_worktable12';
...
{
$form->fields['nome']->autosuggest_table = 'worktable_worktable12';
...
{
$form->fields['organizzazioneentesocieta']->autosuggest_table = 'worktable_worktable12';
...
$form->fields['organizzazioneentesocieta']->autosuggest_destfields = 'codicebadge,cognome,nome';
    ...
    $form->draw();
      ...
      $stmt = 'select ' . $report_fields . ' from worktable_worktable19';
