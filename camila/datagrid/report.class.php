<?php
  ...
  class report
  {
      ...
      function report($stmt, $title, $orderby = '', $direction = 'asc', $mapping = '', $ordermapping = null, $keys = '', $defaultfields, $filter, $canupdate = true, $candelete = false)
      {
          ...
          $this->editcolumscookiename = CAMILA_APPLICATION_NAME . preg_replace('/[^a-z0-9]/', '', $_SERVER['PHP_SELF']);
...
//    $_CAMILA['page']->add_userdefined($js);
          ...
          $code .= "var a = '" . str_replace(array("'","\\u0000"), array("\'",""), $jarr2) . "'; camilatablemenu_init(a);} )</script>";
