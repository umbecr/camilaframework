...
if ($this->autosuggest_advanced_script == '')
      ...
      if ($this->updatable && $this->autosuggest_table!='') {
          $code  = ( '<link rel="stylesheet" type="text/css" media="all" href="' .CAMILA_LIB_DIR .'autosuggest/css/autosuggest_inquisitor.css" />');
          $code .= ( '<script src=\''.CAMILA_LIB_DIR.'autosuggest/js/bsn.AutoSuggest_2.1.3.js\'></script>' );
