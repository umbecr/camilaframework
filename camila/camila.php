...
/* This File is part of Camila PHP Framework
  ...
  require(CAMILA_LIB_DIR.'m2translator/M2Translator.class.php');
...
//$_CAMILA['db']->Execute("SET CHARACTER SET 'utf8'");
  ...
  if (!$_CAMILA['db'])
      camila_error_page(strip_tags($connerr));
